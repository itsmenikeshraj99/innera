...
type Props = NativeStackScreenProps<RootStackParamList, 'HindiChapters'>;

export default function HindiChaptersScreen({ route }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>कोई अध्याय नहीं मिला</Text>
          }
        />
      )}
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  arrow: { color: '#8B1A1A', fontSize: 12 },
  topicsContainer: {
    borderTopWidth: 1,
  ...
  bullet: { color: '#8B1A1A', fontSize: 12, marginTop: 2 },
