...
type Props = NativeStackScreenProps<RootStackParamList, 'SanskritChapters'>;

export default function SanskritChaptersScreen({ route }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>कोई पाठ नहीं मिला</Text>
          }
        />
      )}
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  arrow: { color: '#4A235A', fontSize: 12 },
  topicsContainer: {
    borderTopWidth: 1,
  ...
  bullet: { color: '#4A235A', fontSize: 12, marginTop: 2 },
